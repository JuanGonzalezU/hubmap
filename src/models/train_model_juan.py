...
lr = 0.1
loss_fn = nn.CrossEntropyLoss(ignore_index=0) # this is also called "criterion"/"cost function" in some places
...
for epoch in range(epochs):
    ...
    if best_loss is None or test_loss < best_loss:
        best_loss = test_loss
        with open('/home/juandres/semillero_bcv/hubmap/models/test.pt', 'wb') as fp:
